...
<template>
  ...
  >
    <span class="relative h-[14px] w-4 overflow-hidden">
      <span
        class="top absolute left-0 top-0 h-[2px] w-4 translate-x-0 bg-slate-900"
        :class="{
      ...
      />
      <span
        class="middle absolute left-0 top-[6px] h-[2px] w-4 translate-x-2 bg-slate-900"
        :class="{
      ...
      />
      <span
        class="bottom absolute left-0 top-3 h-[2px] w-4 translate-x-1 bg-slate-900"
        :class="{
