...
<template>
  <div
    class="group relative mb-4 overflow-x-auto bg-$pr-code-tab-bg -mx-6"
    :class="[`language-${language}`]"
  >
    <span
      v-if="language"
      class="absolute right-2 top-[2px] z-2 text-xs font-medium leading-6 text-$pr-c-code-dimm opacity-100 transition-opacity-400 group-hover:opacity-0"
    >
      {{ language }}
    </span>
